...
def load_data(directory, random_seed):
    ...
    d_gsm = np.genfromtxt(directory + '/d_gs.csv', delimiter=',')
    d_ssm = np.genfromtxt(directory + '/d_ss.csv', delimiter=',')
    d_tsm = np.genfromtxt(directory + '/d_ts.csv', delimiter=',')

    m_fsm = np.genfromtxt(directory + '/m_fs.csv', delimiter=',')
    m_gsm = np.genfromtxt(directory + '/m_gs.csv', delimiter=',')
    m_ssm = np.genfromtxt(directory + '/m_ss.csv', delimiter=',')

    all_associations = pd.read_csv(directory + '/all_md_pairs.csv', names=['miRNA', 'disease', 'label'])
